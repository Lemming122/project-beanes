...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "49EFB"  # Playfab Title Id
        self.SecretKey: str = "RUTX4Q3B3T1W9RK5PNZDPBMUF9IPXWQI9K3IJJOUMW9IEWUEJH"  # Playfab Secret Key
        self.ApiKey: str = "OC|1186375167886799|ae1458c7c1021a1d0ece4f1db2633358"  # App Api Key (Oculus/Graph API)
...
def titledata():
    response_data = {
        ...
        "BundleBoardSign": "<color=#ff4141>DISCORD.GG/VycQSqkE</color>",
        "BundleKioskButton": "<color=#ff4141>DISCORD.GG/VycQSqkE</color>",
        "BundleKioskSign": "<color=#ff4141>DISCORD.GG/VycQSqkE</color>",
        "BundleLargeSign": "<color=#ff4141>DISCORD.GG/VycQSqkE</color>",
        "SeasonalStoreBoardSign": "<color=red>RATE THE GAME 5 STARS!</color>\n<color=blue>.GG/VycQSqkE</color>",
        # Text and Messages
        "EmptyFlashbackText": "FLOOR TWO NOW OPEN\n FOR BUSINESS\n\nSTILL SEARCHING FOR\nBOX LABELED 2021",
        "MOTD": "<color=#FFC0CB>WELCOME TO PROJECT BEANIE!</color>\n\n<color=#0099c2>CURRENT UPDATE: METRO 2024</color>\n<color=#cacfd2>BOOST THE DISCORD FOR ALL COSMETICS</color>\n<color=#41ff80>HARMONY MADE THIS MOTD</color>\n<color=#6417ff>OUR DEVELOPERS ARE: HARMONY</color>\n<color=#ac1a00>OWNER : ELLGT </color>\n\n<color=#91A3B0>DISCORD.GG/VycQSqkE</color>",
        "TOBAlreadyOwnCompTxt": "DISCORD.GG/VycQSqkE",
        "TOBAlreadyOwnPurchaseBundle": "PROJECT BEANIE",
        "TOBDefCompTxt": "DISCORD.GG/VycQSqkE",
        "TOBDefPurchaseBtnDefTxt": "PROJECT BEANIE",
        # Legal and Versions
        "EnableCustomAuthentication": True,
        "LatestPrivacyPolicyVersion": "2024.09.20",
        "LatestTOSVersion": "2024.09.20",
        "TOS_2024.09.20": "DISCORD.GG/VycQSqkE",
        ...
        "NewsFeedUrl": "DISCORD.GG/VycQSqkE",
